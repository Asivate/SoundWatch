...
public class Constants {
    ...
    public interface ACTION {
        String MAIN_ACTION = "edu.washington.cs.soundwatch.utils.action.main";
        String PREV_ACTION = "edu.washington.cs.soundwatch.utils.action.prev";
        String PLAY_ACTION = "edu.washington.cs.soundwatch.utils.action.play";
        String NEXT_ACTION = "edu.washington.cs.soundwatch.utils.action.next";
        String STARTFOREGROUND_ACTION = "edu.washington.cs.soundwatch.utils.action.startforeground";
        String STOPFOREGROUND_ACTION = "edu.washington.cs.soundwatch.utils.action.stopforeground";
    }
